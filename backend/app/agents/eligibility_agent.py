"""Eligibility agent skeleton.

Implements the AgentProposal contract from
docs/DONE_DEFINITION.md §AI agent backend skeleton A2.
Real implementation lands in P8 alongside the Financier Eligibility
queue + eval suite. Per docs/adr/0001-pii-view-claims.md §6, agent JWTs
hold zero `pii:view:*` scopes — codified by AGENT_PII_CLAIMS.
"""
