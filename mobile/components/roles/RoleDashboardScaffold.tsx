...
function getActionTarget(role: StakeholderRole, action: string) {
  ...
  const targets: Record<StakeholderRole, Array<[string, string]>> = {
    ...
    homeowner: [
      ...
      ["access", "/(homeowner)/_embedded/terms-detail"],
      ["terms", "/(homeowner)/_embedded/terms-detail"],
      ["pledge", "/(homeowner)/_embedded/pledge-detail"],
      ["drs", "/(homeowner)/_embedded/drs-detail"],
      ["gate", "/(homeowner)/_embedded/drs-detail"],
      ["blocker", "/(homeowner)/_embedded/blocker-detail"],
      ["deploy", "/(homeowner)/_embedded/deployment-detail"],
      ["go-live", "/(homeowner)/_embedded/deployment-detail"],
      ["compare", "/(homeowner)/_embedded/compare-bill"],
      ["health", "/(homeowner)/_embedded/system-health"],
    ...
    electrician: [
      ["site", "/(electrician)/projects"],
      ["capture", "/(electrician)/projects"],
      ["photo", "/(electrician)/projects"],
      ["reading", "/(electrician)/projects"],
      ["checklist", "/(electrician)/projects"],
      ["signoff", "/(electrician)/projects"],
      ["lead", "/(electrician)/profile"],
      ["license", "/(electrician)/profile"],
      ["ticket", "/(electrician)/projects"],
      ["data", "/(electrician)/projects"],
      ["crew", "/(electrician)/projects"],
      ["job", "/(electrician)/projects"],
    ],
    admin: [
      ["drs", "/(admin)/projects"],
